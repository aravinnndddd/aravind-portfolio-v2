...
export const Project = () => {
  const projects = [
    ...
    },
    {
      ...
      dis: "PopzzMedia is a premium landing page for an online course, crafted to drive engagement and conversions. With a bold design, a persuasive headline, a demo video, and a countdown timer, it delivers a high-energy user experience optimized for action.",
      link: "https://popzzmedia.com/",
    },
    {
      id: 6,
      title: "CineBox",
  ...
  return (
    <div
      id="projects"
      className="flex flex-col  h-[100vh] m-5  border-b-2 border-neutral-500"
    >
          ...
          return (
            ...
            >
              ...
              <div className="flex md:flex-row flex-col  items-center h-full w-full gap-5 mx-5">
                <a className="md:w-[40%]" href={project.link} target="_blank">
                  <img
                    className="md:grayscale md:hover:grayscale-0 hover:scale-105 transition-all ease duration-500 rounded-lg md:w-[100%] flex md:flex-col md:h-[40vh] h-[30vh]  mt-[10vh] md:mt-[10px]"
                    src={project.img}
                    alt="proj"
                  />
                </a>
              ...
              <div className="absolute md:top-[25px] md:left-[25px] top-[15px] items-center left-[15px] flex gap-2 w-fit h-[30px]">
                ...
                <div
                  ...
                  className="bg-green-500 md:w-8 md:h-8 h-6 w-6 items-center cursor-pointer justify-center rounded-full flex"
                >
                  <MoveDown size={15} />
                </div>
              </div>
      ...
      <div className="relative flex top-[75vh] justify-center md:justify-normal md:flex md:top-[20vh] md:left-10">
        <div className="md:flex-col flex gap-2  w-fit ">
          <div className="bg-red-500 md:w-8 md:h-8 h-6 w-6 rounded-full  cursor-pointer items-center flex justify-center">
            <MoveUp size={15} />{" "}
          </div>
          ...
          <div className="bg-green-500 md:w-8 md:h-8 h-6 w-6 items-center cursor-pointer justify-center rounded-full flex">
            <MoveDown size={15} />
          </div>
